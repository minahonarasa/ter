...
## Files in the package:
	There are four files in this package:
         ...
         “main.py”: This file includes all functions necessary to implement the game to collect the user input and compare it to the CPU random choice and print the correct information that who is the winner:
	...
	“test_passy.py”: This file imports pytest includes a different combination of input for the cases that the tests suppose to pass
		- when the user wins
		- when the CPU wins
		- when it is a tie
	...
	“test_fail.py”: This file imports pytest and every test in this file suppose to fail softly.
		- When it is a tie game, check if an  message is printed. 
		- When “find_winnner“ returns incorrect status and the “print_winning_mesg”  prints an invalid message
		- If the user input is invalid, but the game prints the winning message.
		- "to_do" part: I would like to develope a function for invalid charachter input for “print_winning_mesg” and catch the exceptions.
	...
	“test_patch.py”:  This file mocks user input by “unnitest.mock” :
		...
		- “to_do” part: I would like to develop a  test for invalid characters input to the above functions by catching exceptions.
...
## To_do: 
	...
	- Add exceptions and test them in the testing files.


## Docker file number 1: 
Here the first Docker file is developed. One for running main.py and to play the game only. For the second Docker part (running the tests), a second Docker file is used and another github repository is created.
...
#Docker file number 2: I made a second directory/repository for this project. Please see the other readme.txt for the next Docker project.
