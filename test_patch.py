...
class test_me(unittest.TestCase):
    ...
    #the followoing cases should pass with lower case
    ...
    """the follwing test cases should be implemented and an Exception should be caught
    wrong input (upper and lower), numbers, special charachters
    #patch should raise an exception"""

    fail_cases1 = ['a','A','x','y', 'X','Y']
    fail_cases2 = ['1','', '.', '%', '*']
    """have to find error in assertRaises, sorry, I am trying to finish it on time """
    # @unittest.mock.patch('builtins.input', create= True)
